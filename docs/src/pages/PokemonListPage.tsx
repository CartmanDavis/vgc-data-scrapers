...
export function PokemonListPage() {
  ...
  const filtered = useMemo(() =>
    search ? rows.filter(r => r.species.toLowerCase().includes(search.toLowerCase())) : rows,
  [rows, search]);
    ...
    <div className="list-page">
      <div className="list-page__header">
        <div>
          ...
          <p className="list-page__subtitle">Usage statistics across all M-A tournaments</p>
        </div>
        {!loading && !error && (
          <input
